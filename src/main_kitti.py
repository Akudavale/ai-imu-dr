...
#%%
class KITTIArgs():
        path_data_base = "C:\\Users\\HP\\Desktop\\rawdata"
        path_data_save = "C:\\Users\\HP\\Desktop\\analyze the AI based trajectory estimation method from 6D IMU data\\AI-IMU_Dead-Reckoning\\ai-imu-dr-master\\data"
        path_results = "C:\\Users\\HP\\Desktop\\analyze the AI based trajectory estimation method from 6D IMU data\\AI-IMU_Dead-Reckoning\\ai-imu-dr-master\\results"
        path_temp = "C:\\Users\\HP\\Desktop\\analyze the AI based trajectory estimation method from 6D IMU data\\AI-IMU_Dead-Reckoning\\ai-imu-dr-master\\temp"
